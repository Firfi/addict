...
create table "addiction" ("name" VARCHAR NOT NULL PRIMARY KEY);
create table "blog" ("id" VARCHAR NOT NULL PRIMARY KEY,"userid" VARCHAR NOT NULL,"addictionid" VARCHAR NOT NULL);
...
create table "post" ("id" VARCHAR NOT NULL PRIMARY KEY,"userid" VARCHAR NOT NULL,"text" VARCHAR,"measurement" BIGINT,"blogid" VARCHAR NOT NULL,"accesslevel" INTEGER NOT NULL);
create table "user" ("id" VARCHAR NOT NULL PRIMARY KEY,"name" VARCHAR,"email" VARCHAR,"avatarURL" VARCHAR);
